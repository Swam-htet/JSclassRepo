...
function onClickHandler(e) {
    console.log("This is own client function");
    console.log(e);
}
    ...
    return (
        <main className={styles.main}>
            <div className={styles.description}>
                ...
                {/*    true?'Success':"Fail"*/}
                {/*}*/}
                {/*<Button data={"As you like"}/>*/}

                {/*<button className={'btn'}>Click me as you like</button>*/}

                {/*<Profile data={user}/>*/}

                {/*<Conditional data={"Success"}/>*/}

                {/*<ListRender data={products}/>*/}

                {/*<Button data='Click Here' onclick={onClickHandler}/>*/}
